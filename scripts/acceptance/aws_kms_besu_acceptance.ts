...
import { parseKmsDerSignature } from '../../src/crypto/kms_der_parser.js';
import { WOLVERINE_TRUST_REGISTRY_ABI } from '../../src/blockchain/besu/contract_abi.js';
...
export async function runAwsKmsAcceptance(): Promise<void> {
  ...
  const { GetPublicKeyCommand, SignCommand } = await import('@aws-sdk/client-kms');
  ...
  // Extract uncompressed public key (last 65 bytes of DER SPKI)
